  ...
  return (
    <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-1.5 pt-1">
              {vacantSundays.map((dateStr) => (
                <button
                  ...
                  className="px-2.5 py-1 rounded-lg bg-amber-200/80 dark:bg-amber-900/60 text-amber-900 dark:text-amber-200 font-semibold hover:bg-amber-300 flex items-center gap-1 cursor-pointer transition-colors"
                >
      ...
      {vacantEvents.length > 0 && (
        <div className="p-3.5 rounded-xl bg-indigo-50 dark:bg-indigo-950/30 border border-indigo-200 dark:border-indigo-800 flex items-center justify-between text-xs text-indigo-900 dark:text-indigo-200">
          ...
          <button
            ...
            className="px-2.5 py-1 rounded-lg bg-indigo-600 text-white font-semibold hover:bg-indigo-700 shrink-0 ml-2"
          >
            Assign
          </button>
        </div>
            ...
            <div>
              ...
              <div className="mt-1 flex items-center gap-2">
                {selectedEntry.songTitle ? (
                  ...
                  <span className="px-2.5 py-1 rounded-md text-xs font-bold bg-amber-100 dark:bg-amber-950 text-amber-800 dark:text-amber-300 border border-amber-200">
